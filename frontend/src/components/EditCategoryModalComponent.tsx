    ...
    return (
        <Modal
            ...
            <div className="Modal__titleBar">
                <h2>{props.isEdit ? "Modifier la catégorie" : "Créer une catégorie"}</h2>
                <button className={"Modal__closeButton"} onClick={props.onCancelled} aria-hidden="true" aria-label="Fermer">
                    <FontAwesomeIcon icon={faXmark}/>
                </button>
            </div>
            <div className="Modal__content">
                <form id={"categoryForm"} onSubmit={onSubmit} className="Modal__categoryForm">
                    <div className="Modal__categoryForm_item Modal__categoryForm__name">
                        <label htmlFor="name">Nom de la catégorie</label>
                        <input type="text" name="name" id="name" value={category.name}
                               onChange={(e) => setCategory({...category, name: e.target.value})} required/>
                    </div>
                    <div className="Modal__categoryForm_item Modal__categoryForm__description">
                    ...
                    <div className="Modal__categoryForm_item Modal__categoryForm__color">
                    ...
                    <div className={"Modal__categoryForm_validation" + (messageError === "" ? "" : " --hasErrors")}>
                        <p>{messageError}</p>
                    </div>
